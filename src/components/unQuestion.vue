<template>
  <div class="component-wrapper unquestion">
    <div class="component-container" v-bind:style="'height:'+850*scaleR+'px'">
      <div class="question-wrapper">
        <div class="question" v-bind:style="isMobile ? '' : 'font-size:'+72*scaleR+'px;margin-bottom:'+60*scaleR+'px'">
