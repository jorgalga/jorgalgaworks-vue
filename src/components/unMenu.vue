  ...
  <div class="component-wrapper unmenu">
    ...
    <div class="component-container" v-bind:style="isMobile ? '' : 'font-size:'+18*scaleR+'px'">
      <div id="nav">
        ...
        <router-link id="agenda-desktop" v-bind:style="'padding:'+45*scaleR+'px'" to="/agenda">{{data.page_names.agenda}}<span class="underline-container"><span class="underline"></span></span></router-link>
