    ...
    <div ref="menucontainer" class="component-container hidden">
      <nav>
        <ul>
          ...
          <li><router-link v-bind:to="'/proposito/' +clang" v-html="data.copy[clang].menu_links.purpose"></router-link></li>
          ...
          <li><a target="_blank" href="http://blog.onesaitplatform.com/" v-html="data.copy[clang].menu_links.blog"></a></li>
        </ul>
      </nav>
