var dataConfig = {
  ...
  copy: {
    en: {
      ...
      cookie_message: '<p> We use our own and third party cookies to improve the user experience. If you continue to browse we understand that you accept our <a href="https://www.minsait.com/en/cookies-policy" target="_blank"> Cookies policy</a>.</p> ',
    ...
    es: {
      ...
      cookie_message: '<p>Utilizamos cookies propias y de terceros para mejorar la experiencia del usuario a través de su navegación. Si continúa navegando entendemos que acepta su uso. <a href="https://www.minsait.com/es/politica-de-cookies" target="_blank">Política de cookies</a></p>',
